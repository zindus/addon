...
pref("extensions.zindus.system.as_chunk_size_scale",      100);
...
pref("extensions.zindus.system.zm_prefer_soapurl_scheme", "https");  // scheme to prefer if multiple <soapURL>'s are recieved
pref("extensions.zindus.system.zm_share_service_url",     "xxx");    //
pref("extensions.zindus.system.gd_data_transfer_scheme",  "https");  // scheme to use for Google Contacts get+set (auth always https)
...
pref("extensions.zindus.system.gd_confirm_on_erase",      true);     // user must confirm if most/all google contacts are to be deleted
