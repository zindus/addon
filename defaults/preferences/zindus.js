...
//
pref("extensions.zindus.system.SyncGalMdInterval",      604800);     // how often the entire GAL is requested
pref("extensions.zindus.system.SyncGalEnabledRecheck",  2);          // how many SyncGalMdInterval's before IfFewer is retested
pref("extensions.zindus.system.SyncGalEnabledIfFewer",  500);        // 5 sync gal if it contains less than this many contacts
