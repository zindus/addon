 ...
 * 
 * ***** END LICENSE BLOCK *****/
// $Id: const.js,v 1.226 2009-11-06 00:00:20 cvsuser Exp $

const APP_NAME="zindus";
const APP_VERSION_NUMBER="0.8.14.20091106.113519";                      // this line generated by build.sh
const APP_VERSION_DATA_CONSISTENT_WITH="0.8.14.20091104.153039";        // remove the data files (forcing a slow sync) if data was
...
const GD_MY_CONTACTS      = "Contacts";            // Google system group name
const GD_SUGGESTED        = "Suggested Contacts";  // Google system group name (faked)
