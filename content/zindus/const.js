 ...
 * 
 * ***** END LICENSE BLOCK *****/
// $Id: const.js,v 1.205 2009-07-03 05:08:26 cvsuser Exp $

const APP_NAME="zindus";
const APP_VERSION_NUMBER="0.8.10.20090630.132900";                      // this line generated by build.sh
const APP_VERSION_DATA_CONSISTENT_WITH="0.8.10.20090703.064903";        // remove the data files (forcing a slow sync) if data was
// const not used APP_VERSION_DATA_CONSISTENT_WITH="0.8.2.20081029.145135";        // remove the data files (forcing a slow sync) if data was
                                                                       // generated by a software version older than this

// TODO next time we force a slow, sync, change SyncGalEnabled to zm_sync_gal_enabled, see syncfsm.js:
...
const BUG_REPORT_URI_HTML        = "<a href='http://www.zindus.com/faq-thunderbird/#toc-reporting-bugs'>http://www.zindus.com/faq-thunderbird/#toc-reporting-bugs</a>";
