...
// leni copied from http://mxr.mozilla.org/mozilla/source/js/src/xpconnect/loader/JSON.jsm
// as recommended by: https://developer.mozilla.org/En/JSON
  ...
  toString: function JSON_toString(aJSObject, aKeysToDrop) {
    ...
    function append_piece(aObj) {
      ...
      // for all arrays from either outside this module or a sandbox
		...
		zinAssertAndLog(false, typeof(aObj));
