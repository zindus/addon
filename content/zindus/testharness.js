...
TestHarness.prototype.testContactGoogle2 = function()
{
	...
	<link rel='http://schemas.google.com/contacts/2008/rel#photo' type='image/*' href='https://www.google.com/m8/feeds/photos/media/xxx%40gmail.com/1bce32b609b6606a'/> \
	@@api_version@@\
...
{
	var xmlString = "\
	<entry gd:etag='&quot;YDwqeyI.&quot;' xmlns='http://www.w3.org/2005/Atom' xmlns:gContact='http://schemas.google.com/contact/2008' xmlns:gd='http://schemas.google.com/g/2005'> \
	  <id>http://www.google.com/m8/feeds/contacts/xxx%40gmail.com/base/1bce32b609b6606a</id> \
	  <updated>2010-09-21T18:18:03.080Z</updated> \
	  <app:edited xmlns:app='http://www.w3.org/2007/app'>2010-09-21T18:18:03.080Z</app:edited> \
	  <category scheme='http://schemas.google.com/g/2005#kind' term='http://schemas.google.com/contact/2008#contact'/> \
	  <title>acme Lastname</title> \
	  <content>US</content> \
	  <link rel='self' type='application/atom+xml' href='https://www.google.com/m8/feeds/contacts/xxx%40gmail.com/thin/1bce32b609b6606a'/> \
	  <link rel='edit' type='application/atom+xml' href='https://www.google.com/m8/feeds/contacts/xxx%40gmail.com/thin/1bce32b609b6606a'/> \
	  <link rel='http://schemas.google.com/contacts/2008/rel#photo' type='image/*' href='https://www.google.com/m8/feeds/photos/media/xxx%40gmail.com/1bce32b609b6606a'/> \
	  <gd:name><gd:fullName>acme Last</gd:fullName><gd:givenName>acme</gd:givenName><gd:familyName>LastName</gd:familyName></gd:name> \
      <gd:organization rel='http://schemas.google.com/g/2005#work'> \
	    <gd:orgName>Art in Action</gd:orgName> \
	    <gd:orgDepartment>SLX</gd:orgDepartment> \
	  </gd:organization> \
      <gd:organization rel='http://schemas.google.com/g/2005#other'/> \
      <gd:organization rel='http://schemas.google.com/g/2005#work'> \
	    <gd:orgName>Art in Action</gd:orgName></gd:organization> \
      <gd:organization primary='true' rel='http://schemas.google.com/g/2005#other'> \
	    <gd:orgName>Art in Action</gd:orgName> \
	  </gd:organization> \
	  <gd:email rel='http://schemas.google.com/g/2005#other' address='acme1@example.org'/> \
	  <gContact:groupMembershipInfo deleted='false' href='http://www.google.com/m8/feeds/groups/xxx%40gmail.com/base/6'/> \
	</entry>";
	...
	if (true)
	{
		...
		this.m_logger.debug("contact.toString: after construction: " + contact.toString());

		let properties = contact.properties;

		this.m_logger.debug("contact properties: " + aToString(properties));

		properties['organization_orgName'] = "Fred Pty Ltd";
